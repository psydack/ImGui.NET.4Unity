...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImFontAtlasPtr
    {
        ...
        public uint AddCustomRect(int width, int height)
        {
            ImFontAtlasRect* out_r = null;
            uint ret = ImGuiNative.ImFontAtlas_AddCustomRect((ImFontAtlas*)(NativePtr), width, height, out_r);
            return ret;
        }
        public uint AddCustomRect(int width, int height, ImFontAtlasRectPtr out_r)
        {
            ImFontAtlasRect* native_out_r = out_r.NativePtr;
            uint ret = ImGuiNative.ImFontAtlas_AddCustomRect((ImFontAtlas*)(NativePtr), width, height, native_out_r);
            return ret;
        }
        ...
        public bool GetCustomRect(uint id, ImFontAtlasRectPtr out_r)
        {
            ImFontAtlasRect* native_out_r = out_r.NativePtr;
        ...
        public void RemoveCustomRect(uint id)
        {
